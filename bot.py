...
TOKEN = "8425955011:AAHeowquUceZtWHCW7iB7RfQhwnWlH4vWv0"   # ← сюда вставь свой токен
...
# Создаём Application для работы с Telegram
...
async def select_plan(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.answer()
    parts = query.data.split("_")  # plan_1000_1
    price = parts[1]
    months = parts[2]
